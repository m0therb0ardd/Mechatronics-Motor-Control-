...
#     elif (selection == 'n'):
#         ref, accel_ref = genRef('cubic')  # Get trajectory with acceleration
#         size = len(ref)
        
#         t = range(size)  # Time index for plotting

#         plt.plot(t, ref, 'r*-', label="Position")
#         plt.plot(t, accel_ref, 'g*-', label="Acceleration")
#         plt.legend()
#         plt.xlabel('Time Step')
#         plt.ylabel('Value')
#         plt.title('Cubic Trajectory and Acceleration')
#         plt.show()
